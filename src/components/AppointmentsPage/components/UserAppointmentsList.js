...
const UserAppointmentsList = ({
  formatMessages, userAppointments, activeAppointment, setActiveAppointment,
}) => (
  <ListGroup className="user-appointment-list">
    {
            userAppointments.map((userAppointment) => {
              ...
              return (
                <ListGroupItem className={`list-item ${className}`} onClick={() => { setActiveAppointment(userAppointment); }}>
