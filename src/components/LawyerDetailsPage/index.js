...
const LawyerDetailsPage = ({
  className, lawyerDetails, getLawyerDetails: getLawyerDetailsAction, match,
}) => {
  useEffect(() => {
        ...
        <Row>
          <Col md="8">
            <div className="image section">
              ...
              <div className="profile-photo" style={{ backgroundImage: `url(${imgUrl})` }} />
            ...
            <div className="specialization section">
              ...
              <div className="content">
                {specializationIds
                && specializationIds.split(',').map(
                  (id) => <span className="element">{specializationsMap[id].specialization}</span>,
                )}
              </div>
            </div>
            ...
            <div className="contact-appointment section">
              <div className="contact">
                ...
                <div className="element">
                  <div className="icon-element">
                    <div className="icon"><Icon name="fax" /></div>
                ...
                <div className="element">
                  ...
                  <div className="languages">
                    {languageIds && languageIds.split(',').map((id) => (
                      <span>
...
export default connect(mapStateToProps, { getLawyerDetails })(LawyerDetailsPage);
