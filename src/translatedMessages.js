export default {
  ...
  'app.footer.aboutAvoPlan': 'Advoplan',
  ...
  'app.footer.AdvoplanPro': 'A(d)voplan Pro',
  ...
  'app.loginPage.loginTitle': 'Advoplan',
  'app.loginPage.resetPwdTitle': 'Neues Passwort eingeben',
  'app.loginPage.loginBtnText': 'Einloggen',
  'app.loginPage.registerTitle': 'Advoplan',
  'app.loginPage.registerBtnText': 'Neu bei Advoplan? Jetzt registrieren',
  ...
  'app.loginPage.newToAvoplan': 'Neu auf Advoplan?',
  'app.loginPage.wantToStayConnected': 'Ich möchte in Verbindung bleiben.',
  'app.loginPage.agreeConditions':
    'Ich akzeptiere die Nutzungsbedingungen von Advoplan',
  'app.loginPage.pwdDescription':
    'Mit Ihren Passwort können Sie auf Ihr Advoplan-Konto zugreifen und so Ihre Beratungstermine verwalten',
  ...
  'app.loginPage.alreadyHaveAnAccount': 'Ich habe ein Advoplan-Konto',
